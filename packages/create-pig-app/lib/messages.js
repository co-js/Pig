...
exports.help = function() {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/co-js/pig/issues/new')}
  `;
};

exports.exampleHelp = function() {
  return `Example from https://github.com/co-js/pig/tree/master/examples/ ${output.param(
    'example-path'
  )}`;
};
...
For example:
  ${chalk.cyan(program.name)} ${chalk.green('my-pig-app')}
...
exports.start = function(projectName) {
  ...
  ${chalk.green('https://github.com/jaredpalmer/pig/issues')}
`;
};
